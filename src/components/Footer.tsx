      ...
      <div className="container mx-auto py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@fitnesscoach.com" className="text-gray-300 hover:text-fitness-purple transition-colors">
                  info@fitnesscoach.com
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <Link to="/privacy" className="text-gray-400 hover:text-fitness-purple transition-colors text-sm">
              سياسة الخصوصية
            </Link>
            <Link to="/terms" className="text-gray-400 hover:text-fitness-purple transition-colors text-sm">
              الشروط والأحكام
            </Link>
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-fitness-purple transition-colors">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-fitness-purple transition-colors">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
            ...
            <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-fitness-purple transition-colors">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
